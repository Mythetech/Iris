...
public static class RegistrationExtensions
{
    ...
    public static IServiceCollection AddIrisMessageBus(this IServiceCollection services)
    {
    ...
    public static IServiceCollection AddIrisMessageBus(this IServiceCollection services,  params Assembly[] assemblies)
    {
        services.AddSingleton<IMessageBus, InMemoryMessageBus>();
    ...
    public static IServiceProvider UseIrisMessageBus(this IServiceProvider serviceProvider)
    {
    ...
    public static IServiceProvider UseIrisMessageBus(this IServiceProvider serviceProvider, params Assembly[] assemblies)
    {
        var bus = serviceProvider.GetService<IMessageBus>();
        foreach (var assembly in assemblies)
        {
